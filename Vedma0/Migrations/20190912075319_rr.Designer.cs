...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vedma0.Models.ManyToMany.CharacterReflection", b =>
                {
                    b.Property<long>("OwnerId");

                    b.Property<long?>("ReflectionId");

                    b.HasKey("OwnerId", "ReflectionId");

                    b.HasIndex("ReflectionId");

                    b.ToTable("CharacterReflection");
                });
            ...
            modelBuilder.Entity("Vedma0.Models.Preset", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Preset");
                });
            ...
            modelBuilder.Entity("Vedma0.Models.GameEntities.Article", b =>
                {
            ...
            modelBuilder.Entity("Vedma0.Models.GameEntities.Publisher", b =>
                {
                    b.HasBaseType("Vedma0.Models.Preset");

                    b.Property<string>("Adress");

                    b.Property<bool>("AllowAnonymus");
            ...
            modelBuilder.Entity("Vedma0.Models.ManyToMany.CharacterReflection", b =>
                {
                    b.HasOne("Vedma0.Models.GameEntities.Character", "Owner")
                        .WithMany("Contacts")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Vedma0.Models.GameEntities.Character", "Reflection")
                        .WithMany("Watchers")
            ...
            modelBuilder.Entity("Vedma0.Models.GameEntities.Article", b =>
                {
                    b.HasOne("Vedma0.Models.GameEntities.Publisher", "Publisher")
                        .WithMany("Articles")
